...
// pour accéder à la page
  ...
  $absences_users=array_merge($scol_user_liste,$de_user_liste);
  
   //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
$login_autorises=$absences_users;
...
$login_autorises_ajout=$absences_users;
// pour pouvoir  supprimer
$login_autorises_suppression=$absences_users;
// pour pouvoir  modifier
$login_autorises_modif=$absences_users;
// pour pouvoir  accéder à détails : formulaire de modification sans validation
$login_autorises_details=$absences_users;
// pour pouvoir  exporter
$login_autorises_export=$absences_users;
...
$nomgroupe1authentification2="";
   //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
if(isset($_GET['from']))
$pageaccueil='absences_'.$_GET['from'].'.php';
else
$pageaccueil='absences_gest.php';
...
{
	   //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
	$filtre_initial=" where doc_idAbsences = '".$_GET['offre']."' and " ;
	...
	// si il existe bien dans la base eleves 
	 if ($nombre!=0){
		...
		$query= "SELECT  code_etud FROM absences  where id_absence= :offre";
			...
			{echo "problème de concordance d`'identifiants $u->code_etud différent de $e->codeEtu ";
			}
		 }
	 }	
...
if(!isset($erreur)) //S'il n'y a pas d'erreur, on upload
{
    ...
    if(move_uploaded_file($_FILES['docfil']['tmp_name'], $chemin_local_absences . $fichier)) //Si la fonction renvoie TRUE, c'est que ça a fonctionné...
     {
 ...
 $$ci2=mysql_Type_Time($u->$ci2);
  ...
  echo"       <table><tr>  ";
    ...
    //+++++++++++++++++++++++++++on n'affiche pas doc_idVoeu_eleves	+++++++++++++++++++++++++++++++++++++++++++++++++++++++
		 elseif ($unchamps== 'doc_idAbsences' )
			 {
				  echo"<input type='hidden' name='".$unchamps."' value=\"".$$unchamps."\">";
			 }
    //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++		
...
if(in_array($loginConnecte,$login_autorises_suppression) or empty($login_autorises_suppression)){
 ...
 echo "<a href='".$chemin_absences.$doc_lienDoc ."' target=\"_blank\"> Télécharger</A>";
	        echo"</td> </tr>";
	   }
	   //pdo	   
	$req->closeCursor();
