...
$liste_champs_lecture_seule_modif=array('date_debut', 'date_fin','mot_cle', 'motif','commentaire_absence','valide', 'absence_justif', 'statut_absence','absence_log');
...
$filtre_initial="where date_debut > '".strval(intval($annee_courante)-1)."-08-31' and ( mot_cle like '%forum%' or mot_cle like '%promotion%' )  and ";
//$filtre_initial="where date_debut > '".strval(intval($annee_courante)-1)."-08-31' and statut_absence !=2 and statut_absence !=5 and statut_absence !=3 and statut_absence !=6 and statut_absence !=7  and statut_absence !=8 and  statut_absence !=9 and ( mot_cle like '%forum%' or mot_cle like '%promotion%' )  and ";
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
$login_autorises=$comm_user_liste;
...
$login_autorises_modif=$comm_user_liste;
// pour pouvoir  accéder à détails : formulaire de modification sans validation
$login_autorises_details=$comm_user_liste;
// pour pouvoir  exporter
$login_autorises_export=$comm_user_liste;
...
$_POST['statut_absence'] = 1;
	  $message.=" L'absence  a été enregistrée dans la base avec le statut 1-A justifier <br>";
...
echo $nombre;
echo " ".$texte_entite ."(s)pour ". ($annee_courante-1) ."-".$annee_courante."</H2>";}
else{
echo"<center> <h1> ";
...
/* if ($_GET['tout'])
echo"<br><a href=".$URL."?tout=0&".$filtrerech.">Ne voir que les absences à traiter</a>";
else
echo"<br><a href=".$URL."?tout=1&".$filtrerech.">Voir toutes les absences</a>";	 */

echo"<BR><table > ";


echo"Vous pouvez changer l'ordre de tri initial en cliquant sur les entêtes des colonnes </center>";
...
if((in_array($loginConnecte,$login_autorises_suppression) or empty($login_autorises_suppression))  ){
	 ...
	 //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	 	 	echo" </td><td>";	  
     echo "<A href=documentabsences.php?offre=".$$cleprimaire."&".$filtrerech."from=gest >Docs(".$nombreDocs. ").</A>";	
	 //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	 }
	...
	if(in_array($loginConnecte,$login_autorises_export) or empty($login_autorises_export))
		{
	   echo  "<br><hr><FORM  action=../export.php method=POST name='form_export'> ";
