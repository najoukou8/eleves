...
$liste_champs_obligatoires=array('date_debut', 'date_fin', 'duree');
...
$liste_champs_invisibles_modif=array();
//----------------------------------------------
...
$liste_champs_select=array('duree');
...
$liste_champs_tableau=array( 'Nom', 'Prénom 1','annee', 'code_etud', 'date_debut', 'date_fin', 'motif', 'date_modif', 'modifpar','absences_statuts_texte');
$liste_champs_filtre=array('Nom', 'annee','code_etud','absences_statuts_texte');
...
$liste_libelles_tableau=array('Prénom 1'=>'Prénom','annee'=>'Filière');
...
$login_autorises=$scol_user_liste;
...
$login_autorises_modif=array('administrateur', 'jouffral','lemairpi');
// pour pouvoir  accéder à détails : formulaire de modification sans validation
$login_autorises_details=array('administrateur', 'jouffral','lemairpi');
// pour pouvoir  exporter
$login_autorises_export=array('administrateur', 'jouffral','lemairpi');
...
$_POST['statut_absence'] = 1;
	 ...
	 // il faudra aussi envoyer un mail
	  $messagem.="Une absence a été déclarée par ".$nomloginConnecte." vous concernant. Merci de bien vouloir la justifier auquel cas elle sera injustifiée "."  \n";
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++	 
	...
	$_POST['statut_absence']=2; 
		...
		// message affiché :
	$message.="absence justifiée envoi du mail à  informant l'étudiant <br> ";	
	 // il faudra aussi envoyer un mail
	  $messagem.="Votre abence a été justifiée par ".$nomloginConnecte ."  \n";
	...
	if( $_POST['bouton_info_comp']!='')
	  { 
		...
		if ($emailetu !=''){			   
					//envoimail($emailetu ,$objet,stripslashes($_POST['commentaire_absence_aj']));
