...
$texteintro= "<h2 style='color: #d72f2f ; font-family: Vertexio ; margin-top: -15px'>Cette interface est prévue pour les expériences interculturelles et les césures.<br>
...
$liste_champs_tableau=array('Nom','Prénom 1','annee','interculture_statut','libelle_pays','interculture_date_debut','interculture_date_fin','interculture_nbre_jours','interculture_has_stage','interculture_is_cesure','interculture_cesure_validee');
...
$liste_libelles_tableau=array('Prénom 1'=>'Prénom','annee'=>'groupe principal','interculture_nbre_jours'=>'jours validés','interculture_is_cesure'=>'césure','interculture_has_stage'=>'stage','interculture_cesure_validee'=>'césure validée');
...
if ($etudOK)
{
echo"<br><br><i>Une fois votre demande enregistrée, vous pouvez la complèter en joignant des documents : cliquez sur le lien Docs dans le tableau</i> </center>";
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++
echo"<br><br><i>Vous pouvez changer l'ordre de tri initial en cliquant sur les entêtes des colonnes</i> </center>";
//var_dump($_POST);
echo "<br>";
//var_dump($_GET);
