...
<head>
<title>gestion des voeux 9</title>
...
$where="where etudiants_scol.annee like '".$gpecible9."%' ";
//$nom_univ='';
...
if(in_array($login,$voeux_liste9)){
...
foreach ($courspossible9 as $coursenum ){
...
$v=mysql_fetch_object($result) ;
 ...
 //on fait une boucle pour remettre en hiden tous les champs  de la table stage
  ...
  //echo"<input type='hidden' name='mod' value=1>";
	...
	echo "<center><h1>$titrevoeux9</h1><br>";
...
FROM voeux_eleves
WHERE v_id_sondage='".$idsondage9."' and v_num_etudiant='".$codeetu."'
";
