...
$casOn=0;
$texte_table='param_ues_accueil';
// pour afficher dans l'interface le nom des entités de chaque table
$texte_entite='param_ues_accueil';
$texte_entite2='cours';
$texte_entite3='';
$table="param_ues_accueil";
$cleprimaire='param_ues_accueil_id';
$autoincrement='param_ues_accueil_id';
$cleetrangere2='param_ues_accueil_code';
// pour l'ordre d'affichage dans le  select en saisie / modification - peut être vide
$ordrecleeetrangere2=' ORDER BY CODE ';
// restriction dans le  select en saisie / modification - peut être vide
$wherecleeetrangere2=" where CODE not in (select param_ues_accueil_code from param_ues_accueil)  ";
$table2="cours";
$indexlien2='CODE';
$cleetrangere3='';
$ordrecleeetrangere3='';
...
$champ_date_modif='param_ues_accueil_dateModif';
$champ_modifpar='param_ues_accueil_modifPar';
$liste_champs_lies_sup=array();
$liste_champs_lies2=array('CODE','LIBELLE_COURT');
...
$liste_champs_lies_pour_formulaire_ajout2=array('CODE','LIBELLE_COURT','');
// on autorise ou pas le NC
$champs_lies_pour_formulaire_ajout_obligatoire2=1;
$liste_champs_lies_pour_formulaire_ajout3=array();
$champs_lies_pour_formulaire_ajout_obligatoire3=1;
$liste_champs_obligatoires=array();
$liste_champs_lecture_seule_ajout=array();
$liste_champs_lecture_seule_modif=array('param_ues_accueil_code','param_ues_accueil_modifPar','param_ues_accueil_dateModif');
...
$liste_champs_invisibles_modif=array('param_ues_accueil_id');
//----------------------------------------------
...
$liste_champs_select=array('param_ues_accueil_bloc');
$liste_choix_param_ues_accueil_bloc=array('','1',
'2',
'3',
'4',
'5',
...
$liste_champs_tableau=array('param_ues_accueil_code','LIBELLE_COURT','param_ues_accueil_bloc');
...
$liste_libelles_tableau=array('param_ues_accueil_bloc'=>'numéro de bloc UE');
...
$liste_libelles_champ=array('param_ues_accueil_bloc'=>'choisissez un numéro de bloc UE , si cette UE ne fait pas partie d\'un bloc laissez vide');
...
$login_autorises=array('dehemchn','foukan');
...
$login_autorises_clone=array('foukan');
// pour pouvoir  ajouter
$login_autorises_ajout=array('foukan','administrateur','dehemchn');
// pour pouvoir  supprimer
$login_autorises_suppression=array('administrateur','patouilm','dehemchn');
// pour pouvoir  modifier
$login_autorises_modif=array('administrateur','patouilm','dehemchn');
// pour pouvoir  accéder à détails : formulaire de modification sans validation
$login_autorises_details=array('administrateur','patouilm');
// pour pouvoir  exporter
$login_autorises_export=array('dehemchn');
...
if ($unchamps != $autoincrement and $unchamps != $champ_date_modif and $unchamps != $champ_modifpar ){
	 ...
	 // si on a une table liée
	  elseif ($unchamps == $cleetrangere2 ){
		 ...
		 if ($champs_lies_pour_formulaire_ajout_obligatoire2)
		 ...
		 $commentaire=$texte_entite3;
		 	if ($champs_lies_pour_formulaire_ajout_obligatoire3)
