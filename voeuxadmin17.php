...
$where="where etudiants_scol.annee like '".$gpecible17."%' ";
//$nom_univ='';
...
if(in_array($login,$voeux_liste17)){
...
$v=mysql_fetch_object($result) ;
 ...
 //on fait une boucle pour remettre en hiden tous les champs  de la table stage
  ...
  //echo"<input type='hidden' name='mod' value=1>";
	...
	echo "<center><h1>$titrevoeux17</h1><br>";
...
echo "</tr><tr>";
		  ...
		  // echo "<td>Commentaire</td>";
		  	  		 // echo "</tr><tr>";
					 // if ($v_commentaire==''){
						// echo "<td colspan=3><textarea   name='v_commentaire' rows=6 cols=60>".$question_commentaire17_1." \n \n\n".$question_commentaire17_2."  </textarea></td> ";		
						// }
						// else
						// {
...
FROM voeux_eleves
WHERE v_id_sondage='".$idsondage17."' and v_num_etudiant='".$codeetu."'
";
