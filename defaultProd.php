...
if( $_SERVER['SERVER_NAME'] == "localhost" ) {
    echo "<h1 style='margin-top:-11px;font-family :Roboto Condensed; text-align:center ; background-color : #d72f2f ; color : white ; padding : 10px ;text-transform: uppercase; font-size : 50px; font-weight:bold'><img id='loader' src='./icons/ajax3.gif' style='width:32px;'/> *Base des élèves $annee_accueil </h1> ";
        ...
        echo "<h1 style='  margin-bottom: 34px;margin-top:-87px;font-family :Roboto Condensed; text-align:center ; background-image: linear-gradient(#005782, #005782) ; color : white ; padding : 5px ;text-transform: uppercase; font-size : 50px; font-weight:bold'><img id='loader' src='./icons/ajax3.gif' style='width:32px;'/> Base élèves $annee_accueil </h1>";
}
  ...
  <div class="box b" id='websiteavis3' style='background-color:#dc3545 ; color : white' > &#9203; Chargement ... </div>
    ...
    <div class="container">
        <div class="marquee" style='background-color: #82fa9d !important;color:black'>
            <div>
                <b style="background-color: GREEN  ; padding: 4px ; opacity: 0.8 ; border-radius: 4px ;"> <span style="color: red ; font-size: 15px;">&#9888; </span> * INFORMATION : </b> 06/07/24 17h00 >  BASCULE BASE ELEVE/SI/ADE/REFENS/TRIODE EST PREVU POUR LE 15/07/24 L'OPERATION PRENDRA 2/3 JOURS.   
            </div>
        </div>
    </div>
...
color: red;
padding: 2px;
border-radius: 4px;'> 2022/2023 </a><a href='https://web.gi.grenoble-inp.fr/eleves2023' style='background-color: #ffc107;
color: red; margin-left:2px;
padding: 2px;
border-radius: 4px;'> 2023/2024 </a>";
