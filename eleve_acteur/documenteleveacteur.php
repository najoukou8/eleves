...
// pour accéder à la page
  ...
  $eleveacteur_users=array('patouilm','administrateur','janym','viardch');
  
   //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
$login_autorises=$eleveacteur_users;
...
$login_autorises_clone=$eleveacteur_users;
// pour pouvoir  ajouter
$login_autorises_ajout=$eleveacteur_users;
// pour pouvoir  supprimer
$login_autorises_suppression=$eleveacteur_users;
// pour pouvoir  modifier
$login_autorises_modif=$eleveacteur_users;
// pour pouvoir  accéder à détails : formulaire de modification sans validation
$login_autorises_details=$eleveacteur_users;
// pour pouvoir  exporter
$login_autorises_export=$eleveacteur_users;
...
{
	   //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
	$filtre_initial=" where doc_idEleveacteur = '".$_GET['offre']."' and " ;
...
if(!isset($erreur)) //S'il n'y a pas d'erreur, on upload
{
    ...
    if(move_uploaded_file($_FILES['docfil']['tmp_name'], $chemin_local_eleve_acteur . $fichier)) //Si la fonction renvoie TRUE, c'est que ça a fonctionné...
     {
 ...
 $$ci2=mysql_Type_Time($u->$ci2);
  ...
  echo"       <table><tr>  ";
    ...
    //+++++++++++++++++++++++++++on n'affiche pas doc_idVoeu_eleves	+++++++++++++++++++++++++++++++++++++++++++++++++++++++
		 elseif ($unchamps== 'doc_idEleveacteur' )
			 {
				  echo"<input type='hidden' name='".$unchamps."' value=\"".$$unchamps."\">";
			 }
    //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++		
...
if(in_array($loginConnecte,$login_autorises_suppression) or empty($login_autorises_suppression)){
 ...
 echo "<a href='".$chemin_eleve_acteur.$doc_lienDoc ."' target=\"_blank\"> Télécharger</A>";
	        echo"</td> </tr>";
	   }
	   //pdo	   
	$req->closeCursor();
