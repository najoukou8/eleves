 ...
 * Stages
 *
 * @ORM\Table(name="stages", indexes={@ORM\Index(name="code_etudiant_3", columns={"code_etudiant_3"}), @ORM\Index(name="code_entreprise", columns={"code_entreprise"}), @ORM\Index(name="code_tuteur_gi", columns={"code_tuteur_gi"}), @ORM\Index(name="code_etudiant_2", columns={"code_etudiant_2"}), @ORM\Index(name="code_etudiant", columns={"code_etudiant"}), @ORM\Index(name="code_president_jury", columns={"code_president_jury"}), @ORM\Index(name="code_tuteur_gi_shs", columns={"code_tuteur_gi_shs"})})
 * @ORM\Entity
 */
class Stages
{
