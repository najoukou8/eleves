 ...
 * CampagnesDocuments
 *
 * @ORM\Table(name="campagnes_documents")
 * @ORM\Entity
 */
class CampagnesDocuments
{
    /**
     * @var int
     *
     ...
     * @var string
     *
     * @ORM\Column(name="doc_libelle", type="string", length=40, nullable=false, options={"comment"="nom du document"})
     */
    private $docLibelle = '';
     ...
     * @var int
     *
     * @ORM\Column(name="doc_idVoeu_eleves", type="integer", nullable=false, options={"default"="-1","comment"="Identifiant du voeu"})
     */
    private $docIdvoeuEleves = -1;
