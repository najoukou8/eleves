...
/**
 * Apprentissagedocuments
 *
 * @ORM\Table(name="apprentissagedocuments")
 * @ORM\Entity
 */
class Apprentissagedocuments
{
    /**
     * @var int
     *
     ...
     * @var int
     *
     * @ORM\Column(name="doc_idOffre", type="integer", nullable=false, options={"default"="-1","comment"="Identifiant de l'offre"})
     */
    private $docIdoffre = -1;
