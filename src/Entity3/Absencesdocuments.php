 ...
 * Absencesdocuments
 *
 * @ORM\Table(name="absencesdocuments")
 * @ORM\Entity
 */
class Absencesdocuments
{
    /**
     * @var int
     *
     ...
     * @var int
     *
     * @ORM\Column(name="doc_idAbsences", type="integer", nullable=false, options={"default"="-1","comment"="Identifiant de l'absence"})
     */
    private $docIdabsences = -1;
