 ...
 * Annuaire
 *
 * @ORM\Table(name="annuaire2", uniqueConstraints={@ORM\UniqueConstraint(name="id", columns={"id"}), @ORM\UniqueConstraint(name="UId", columns={"UId"})}, indexes={@ORM\Index(name="code-ccp", columns={"code-ccp"}), @ORM\Index(name="index_codeetu", columns={"code-etu"})})
 * @ORM\Entity
 */
class Annuaire
{
