 ...
 * CoursAnnee20112012
 *
 * @ORM\Table(name="cours_annee-2011-2012", indexes={@ORM\Index(name="IDX_CODE", columns={"CODE"}), @ORM\Index(name="IDX_CODE_RATTACHEMENT", columns={"CODE_RATTACHEMENT"}), @ORM\Index(name="IDX_CODE_RUBRIQUE", columns={"CODE_RUBRIQUE"}), @ORM\Index(name="IDX_DIFFUSION_MODE_RESTRICTION", columns={"DIFFUSION_MODE_RESTRICTION"}), @ORM\Index(name="IDX_ETAT_OBJET", columns={"ETAT_OBJET"}), @ORM\Index(name="IDX_CODE_REDACTEUR", columns={"CODE_REDACTEUR"}), @ORM\Index(name="IDX_DIFFUSION_PUBLIC_VISE", columns={"DIFFUSION_PUBLIC_VISE"}), @ORM\Index(name="IDX_DIFFUSION_PUBLIC_VISE_RESTRICTION", columns={"DIFFUSION_PUBLIC_VISE_RESTRICTION"})})
 * @ORM\Entity
 */
