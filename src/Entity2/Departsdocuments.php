 ...
 * Departsdocuments
 *
 * @ORM\Table(name="departsdocuments")
 * @ORM\Entity
 */
class Departsdocuments
{
    /**
     * @var int
     *
     ...
     * @var int
     *
     * @ORM\Column(name="doc_idDepart", type="integer", nullable=false, options={"default"="-1","comment"="Identifiant de l'offre"})
     */
    private $docIddepart = -1;
