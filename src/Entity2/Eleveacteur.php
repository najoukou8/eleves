 ...
 * Eleveacteur
 *
 * @ORM\Table(name="eleveacteur", indexes={@ORM\Index(name="code_etud", columns={"eleveacteur_code_etud"}), @ORM\Index(name="interculture_code_etud", columns={"eleveacteur_code_etud"})})
 * @ORM\Entity
 */
class Eleveacteur
{
