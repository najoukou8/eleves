...
class ExtIa
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="Numéro INE", type="string", length=255, nullable=true)
     */
    private $numéroIne;
     ...
     * @var string
     *
     * @ORM\Column(name="Nat. tit acc", type="string", length=255, nullable=false)
     */
    private $nat.TitAcc;
