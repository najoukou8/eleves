 ...
 * EtudiantsSauv
 *
 * @ORM\Table(name="etudiants_sauv", indexes={@ORM\Index(name="Index_2", columns={"Numéro INE"}), @ORM\Index(name="prenom1", columns={"Prénom 1"}), @ORM\Index(name="Nom", columns={"Nom"})})
 * @ORM\Entity
 */
class EtudiantsSauv
{
