...
/**
 * Eleveacteurdocuments
 *
 * @ORM\Table(name="eleveacteurdocuments")
 * @ORM\Entity
 */
class Eleveacteurdocuments
{
    /**
     * @var int
     *
     ...
     * @var int
     *
     * @ORM\Column(name="doc_idEleveacteur", type="integer", nullable=false, options={"default"="-1","comment"="Identifiant de l'offre"})
     */
    private $docIdeleveacteur = -1;
