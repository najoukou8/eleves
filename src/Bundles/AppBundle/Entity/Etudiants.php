 ...
 * Etudiants
 *
 * @ORM\Table(name="etudiants2", indexes={@ORM\Index(name="prenom1", columns={"Prénom 1"}), @ORM\Index(name="Nom", columns={"Nom"})})
 * @ORM\Entity
 */
class Etudiants
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="`Année Univ`", type="string", length=255, nullable=true, options={"comment"="Année dernière inscription"})
     */
    private $annéeUniv;
     ...
     * @var string|null
     *
     * @ORM\Column(name="Composante", type="string", length=255, nullable=true, options={"comment"="école d'inscription"})
     */
    private $composante;
     ...
     * @var string|null
     *
     * @ORM\Column(name="`Lib dip`", type="string", length=255, nullable=true, options={"comment"="Diplôme"})
     */
    private $libDip;
     ...
     * @var string|null
     *
     * @ORM\Column(name="`Lib étape`", type="string", length=255, nullable=true, options={"comment"="Etape"})
     */
    private $libEtape;
     ...
     * @var string|null
     *
     * @ORM\Column(name="`Lib statut`", type="string", length=255, nullable=true, options={"comment"="statut"})
     */
    private $libStatut;
     ...
     * @var string|null
     *
     * @ORM\Column(name="`Lib profil`", type="string", length=255, nullable=true, options={"comment"="profil"})
     */
    private $libProfil;
     ...
     * @var string|null
     *
     * @ORM\Column(name="`Lib régime`", type="string", length=255, nullable=true, options={"comment"="régime"})
     */
    private $libRégime;
     ...
     * @var string|null
     *
     * @ORM\Column(name="Lib_shn", type="string", length=255, nullable=true, options={"comment"="Sportif haut niveau"})
     */
    private $libShn;
     ...
     * @var string|null
     *
     * @ORM\Column(name="`Etat civ`", type="string", length=255, nullable=true, options={"comment"="etat civil"})
     */
    private $etatCiv;
     ...
     * @var string|null
     *
     * @ORM\Column(name="`Date naiss`", type="string", length=255, nullable=true, options={"comment"="age$$$$age"})
     */
    private $dateNaiss;
     ...
     * @var string|null
     *
     * @ORM\Column(name="`Pays/dept naiss`", type="string", length=255, nullable=true, options={"comment"="Pays de naissance$$$$pays"})
     */
    private $paysDeptNaiss;
     ...
     * @var string|null
     *
     * @ORM\Column(name="Nationalité", type="string", length=255, nullable=true, options={"comment"="Nationalité$$$$pays"})
     */
    private $nationalité;
     ...
     * @var string|null
     *
     * @ORM\Column(name="`Lib sit fam`", type="string", length=255, nullable=true, options={"comment"="situation familiale"})
     */
    private $libSitFam;
     ...
     * @var string|null
     *
     * @ORM\Column(name="Lib_handi", type="string", length=255, nullable=true, options={"comment"="Handicap"})
     */
    private $libHandi;
     ...
     * @var string|null
     *
     * @ORM\Column(name="`Adf lib pays`", type="string", length=255, nullable=true, options={"comment"="Pays adresse parent"})
     */
    private $adfLibPays;
     ...
     * @var string|null
     *
     * @ORM\Column(name="`Lib aide finan`", type="string", length=255, nullable=true, options={"comment"="aide financière"})
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="`Lib bourse`", type="string", length=255, nullable=true, options={"comment"="bourse"})
     */
    private $libBourse;
     ...
     * @var string|null
     *
     * @ORM\Column(name="`Lib quotité travail`", type="string", length=255, nullable=true, options={"comment"="quotité travail"})
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="`Lib CSP parent`", type="string", length=255, nullable=true, options={"comment"="CSP Parents"})
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="`Lib bac`", type="string", length=255, nullable=true, options={"comment"="BAC"})
     */
    private $libBac;
     ...
     * @var string|null
     *
     * @ORM\Column(name="`Lib mention`", type="string", length=255, nullable=true, options={"comment"="BAC mention"})
     */
    private $libMention;
     ...
     * @var string|null
     *
     * @ORM\Column(name="`Année obt bac`", type="string", length=255, nullable=true, options={"comment"="BAC année"})
     */
    private $annéeObtBac;
     ...
     * @var string|null
     *
     * @ORM\Column(name="Lib_type_CGE", type="string", length=255, nullable=true, options={"comment"="Type Concours"})
     */
    private $libTypeCge;
     ...
     * @var string|null
     *
     * @ORM\Column(name="`Lib etb bac`", type="string", length=255, nullable=true, options={"comment"="BAC Lycée"})
     */
    private $libEtbBac;
     ...
     * @var string|null
     *
     * @ORM\Column(name="`Dip tit acc`", type="string", length=25, nullable=true, options={"comment"="Origine"})
     */
    private $dipTitAcc;
     ...
     */
    private $inscrParalleleChgtInscr;
     ...
     * @var string|null
     *
     * @ORM\Column(name="`Lib étab`", type="string", length=255, nullable=true, options={"comment"="DD établissement"})
     */
    private $libétab;
     ...
     * @var string|null
     *
     * @ORM\Column(name="`Pg échange`", type="string", length=255, nullable=true, options={"comment"="Programme échange"})
     */
    private $pgéchange;
     ...
     * @var string|null
     *
     * @ORM\Column(name="`Sens échange`", type="string", length=255, nullable=true, options={"comment"="Sens échange"})
     */
    private $senséchange;
     ...
     * @var string|null
     *
     * @ORM\Column(name="`Lib étab ech`", type="string", length=255, nullable=true, options={"comment"="établissement échange"})
     */
    private $libétabEch;
