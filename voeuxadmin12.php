...
<head>
<title>gestion des voeux IDP ICL</title>
...
$where="where etudiants_scol.annee like '".$gpecible12."%' ";
//$nom_univ='';
...
if(in_array($login,$voeux_liste12)){
...
foreach ($courspossible12 as $coursenum ){
...
$v=mysql_fetch_object($result) ;
 ...
 //on fait une boucle pour remettre en hiden tous les champs  de la table stage
  ...
  //echo"<input type='hidden' name='mod' value=1>";
	...
	echo "<center><h1>$titrevoeux12</h1><br>";
...
echo "</tr><tr>";
		  ...
		  echo "<td>Commentaire</td>";
		  	  		 echo "</tr><tr>";
					 if ($v_commentaire==''){
						echo "<td colspan=3><textarea   name='v_commentaire' rows=6 cols=60 placeholder=\"".$question_commentaire12_1."\"></textarea></td> ";		
						}
						else
						{
...
FROM voeux_eleves
WHERE v_id_sondage='".$idsondage12."' and v_num_etudiant='".$codeetu."'
";
