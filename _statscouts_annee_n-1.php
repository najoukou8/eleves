...
//$filtre='';
$login_autorises_clone=array('administrateur','foukan');
...
$dsn="helico_extr".($annee_courante-1);
$user_sql="moulinette";
$password="moulin";
$host="localhost";
$connexion =Connexion ($user_sql, $password, $dsn, $host);
echo $annee_courante."".$dsn ; 
...
//		echo "<a href=?detail=".$ligne['code'].">".$ligne['nombre']."</a>";		
		...
		if (substr($ligne['code_apogee'],0,1)=='5')
		{
			...
			// je vérifie si ipid  ou non 
			
			$query = "SELECT * FROM `effectifs` WHERE  `code apogee` ='".$ligne['code_apogee']."'"  ; 
