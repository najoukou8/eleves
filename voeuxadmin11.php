...
$where="where etudiants_scol.annee like '".$gpecible11."%' ";
//$nom_univ='';
...
if(in_array($login,$voeux_liste11)){
...
foreach ($courspossible11 as $coursenum ){
...
$v=mysql_fetch_object($result) ;
 ...
 //on fait une boucle pour remettre en hiden tous les champs  de la table stage
  ...
  //echo"<input type='hidden' name='mod' value=1>";
	...
	echo "<center><h1>$titrevoeux11</h1><br>";
...
FROM voeux_eleves
WHERE v_id_sondage='".$idsondage11."' and v_num_etudiant='".$codeetu."'
";
