...
$liste_param_get=array('code_etud_rech','clone','from','offre');
...
foreach($liste_param_get as $unparam )
{
	...
	if ( $_POST[$unparam]!='')
	{
		$filtrerech.=$unparam."=".$_POST[$unparam]."&";
	}
}
...
{
	   //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
	$filtre_initial=" where doc_idportedocument = '".$_GET['offre']."' and " ;
	...
	// si il existe bien dans la base eleves 
	 if ($nombre!=0){
		...
		$query= "SELECT  code_etud FROM portedocuments  where id_portedocument= :offre";
 ...
 $$ci2=mysql_Type_Time($u->$ci2);
  ...
  echo"       <table><tr>  ";
    ...
    //+++++++++++++++++++++++++++on n'affiche pas doc_idVoeu_eleves	+++++++++++++++++++++++++++++++++++++++++++++++++++++++
		 elseif ($unchamps== 'doc_idportedocument' )
			 {
				  echo"<input type='hidden' name='".$unchamps."' value=\"".$$unchamps."\">";
			 }
    //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++		
...
if(in_array($loginConnecte,$login_autorises_suppression) or empty($login_autorises_suppression)){
 ...
 echo "<a href='".$chemin_portedocuments.$doc_lienDoc ."' target=\"_blank\"> Télécharger</A>";
	        echo"</td> </tr>";
	   }
	   //pdo	   
	$req->closeCursor();
