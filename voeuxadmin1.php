...
$where="where etudiants_scol.annee like '".$gpecible1."%' ";
//$nom_univ='';
// on forge le where sql
$wherecours = " 0 ";
$wherecours2 = " 0 ";
$wherecourstot = " 0 ";
foreach ($courspossible1 as $ci){
$wherecours.= " or  code='".$ci."'";
}
foreach ($cours2possible1 as $ci){
$wherecours2.= " or  code='".$ci."'";
$wherecourstot.= " or  code='".$ci."'";
}
$tabletemp="etudiants";
...
if(in_array($login,$voeux_liste1)){
...
//on remplit 1tableau avec les libelles-code cours pour le 2eme gpe
$sqlquery2="SELECT * FROM cours where ".$wherecours2 ." order by CODE";
$resultat2=mysql_query($sqlquery2,$connexion ); 
while ($v=mysql_fetch_array($resultat2)){
$cours_code2[]=$v["CODE"] ;
$cours_libelle2[]=$v["LIBELLE_LONG"] ;
$cours_libelle_a2[$v["CODE"]]=$v["LIBELLE_LONG"];
}
$cours_code2[]='9999';
$cours_libelle2[]='NC';
$cours_libelle_a2[9999]=$v["NC"];
...
$v=mysql_fetch_object($result) ;
 ...
 //on fait une boucle pour remettre en hiden tous les champs  de la table stage
  ...
  //echo"<input type='hidden' name='mod' value=1>";
	...
	echo "<center><h1>Voeux 2eme semestre<br>";
...
//$mail=ask_ldap($v_login_etud,'mail');
    ...
    echo affichechamp('le','date_modif',$v_date_modif,'15',1);
		  	 ...
		  	 echo "</tr><tr>";
echo affichemenuplus2tab ('Voeu 1 '.$titre1_bloc1,'v_voeux1',$cours_libelle,$cours_code,$v_voeux1);
echo affichemenuplus2tab ('Voeu 2 '.$titre1_bloc1,'v_voeux2',$cours_libelle,$cours_code,$v_voeux2);
echo affichemenuplus2tab ('Voeu 3 '.$titre1_bloc1,'v_voeux3',$cours_libelle,$cours_code,$v_voeux3);
echo "</tr><tr>";
echo affichemenuplus2tab ('Voeu 1 '.$titre2_bloc1,'voeu_parcours_1',$cours_libelle2,$cours_code2,$voeu_parcours_1);
echo affichemenuplus2tab ('Voeu 2 '.$titre2_bloc1,'voeu_parcours_2',$cours_libelle2,$cours_code2,$voeu_parcours_2);
echo affichemenuplus2tab ('Voeu 3 '.$titre2_bloc1,'voeu_parcours_3',$cours_libelle2,$cours_code2,$voeu_parcours_3);
...
echo "<table border=1 width='50%'>";
	//echo "<th colspan=5 align=center>Cliquez ci dessous pour le détail des cours</th>";
	echo "</tr><tr>";
	echo "<th>Lien</th><th>Liste ".$titre1_bloc1."</th>";
	//echo "<th>Lien</th><th>Liste ".$titre1_bloc1."</th><th>heures CM</th><th>heures TP</th><th>heures TD</th>";
	 $query2 = "SELECT * FROM cours   where ".$wherecours." order by CODE" ;
    $result2 = mysql_query($query2,$connexion ); 
	while($u=mysql_fetch_object($result2)) {

echo"   <tr><td>" ;  
      if($url_ksup_monobloc==''){echo  "<a href=".$url_ksup_prefixe.$fiche_code_ksup[substr($u->CODE,0,8)].$url_ksup_suffixe." >".substr($u->CODE,0,8)."</a>";}else{echo  "<a href=".$url_ksup_monobloc." >".substr($u->CODE,0,8)."</a>";}
      echo"   </td><td bgcolor='lightgreen'>" ;
     echo  $u->LIBELLE_LONG  ;
      //echo"   </td><td>" ;
      //echo $u->VOLUME_HORAIRE_CM ;
	//        echo"   </td><td>" ;
      //echo $u->VOLUME_HORAIRE_TP ;
	//        echo"   </td><td>" ;
      //echo $u->VOLUME_HORAIRE_TD ;
     echo"        </td> </tr>";
	 }
	echo"</table>";
	...
	echo"   <br><br>" ; 	
echo "<table border=1  width='50%'>";
		echo "<th>Lien</th><th>Liste ".$titre2_bloc1."</th>";
		//echo "<th>Lien</th><th>Liste ".$titre2_bloc1."</th><th>heures CM</th><th>heures TP</th><th>heures TD</th>";
	 $query2 = "SELECT * FROM cours   where ".$wherecours2." order by CODE" ;
    $result2 = mysql_query($query2,$connexion ); 
	while($u=mysql_fetch_object($result2)) {
...
echo"<center> <h2>Il n'y a  pas d'inscrits pour l'instant   ";
echo" </h2></center>  ";}
...
echo"<th>voeu2 ".$titre1_bloc1."</th>";
//echo afficheentete('voeu3','v_voeux3',$_GET['env_orderby'],$_GET['env_inverse'],$filtre,$URL);
echo"<th>voeu3 ".$titre1_bloc1."</th>";
echo"<th>voeu1 ".$titre2_bloc1."</th>";
echo"<th>voeu2 ".$titre2_bloc1."</th>";
echo"<th>voeu3 ".$titre2_bloc1."</th>";
...
FROM voeux_eleves
WHERE v_id_sondage='".$idsondage1."' and v_num_etudiant='".$codeetu."'
";
$result2 = mysql_query($query2,$connexion ); 
...
while($universite2=mysql_fetch_object($result2)) {
 ...
 //on fait une boucle pour créer les variables issues de la table voeux et on leur affecte le resultat du select
  ...
  echo"   </td><td>" ;
		  if ($v_voeux1!='9999'){
if($url_ksup_monobloc==''){echo  "<a href=".$url_ksup_prefixe.$fiche_code_ksup[$v_voeux1].$url_ksup_suffixe." >".$v_voeux1."</a>";}else{echo  "<a href=".$url_ksup_monobloc." >".$v_voeux1."</a>";}	
		}
 else{
 echo 'NC';
 }
      echo"   </td><td>" ;
	  		  if ($v_voeux2!='9999'){
if($url_ksup_monobloc==''){echo  "<a href=".$url_ksup_prefixe.$fiche_code_ksup[$v_voeux2].$url_ksup_suffixe." >".$v_voeux2."</a>";}else{echo  "<a href=".$url_ksup_monobloc." >".$v_voeux2."</a>";}		
  }
 else{
 echo 'NC';
 }
	  echo"   </td><td>" ;	  
	  		  if ($v_voeux3!='9999'){
if($url_ksup_monobloc==''){echo  "<a href=".$url_ksup_prefixe.$fiche_code_ksup[$v_voeux3].$url_ksup_suffixe." >".$v_voeux3."</a>";}else{echo  "<a href=".$url_ksup_monobloc." >".$v_voeux3."</a>";}		
  }
 else{
 echo 'NC';
 }
  echo"   </td><td>" ;	  
	  		  if ($voeu_parcours_1!='9999'){
if($url_ksup_monobloc==''){echo  "<a href=".$url_ksup_prefixe.$fiche_code_ksup[$voeu_parcours_1].$url_ksup_suffixe." >".$voeu_parcours_1."</a>";}else{echo  "<a href=".$url_ksup_monobloc." >".$voeu_parcours_1."</a>";}		
  }
 else{
 echo 'NC';
 }
  echo"   </td><td>" ;	  
	  		  if ($voeu_parcours_2!='9999'){
if($url_ksup_monobloc==''){echo  "<a href=".$url_ksup_prefixe.$fiche_code_ksup[$voeu_parcours_2].$url_ksup_suffixe." >".$voeu_parcours_2."</a>";}else{echo  "<a href=".$url_ksup_monobloc." >".$voeu_parcours_2."</a>";}
  }
 else{
 echo 'NC';
 }
  echo"   </td><td>" ;	  
	  		  if ($voeu_parcours_3!='9999'){
if($url_ksup_monobloc==''){echo  "<a href=".$url_ksup_prefixe.$fiche_code_ksup[$voeu_parcours_3].$url_ksup_suffixe." >".$voeu_parcours_3."</a>";}else{echo  "<a href=".$url_ksup_monobloc." >".$voeu_parcours_3."</a>";}
  }
 else{
 echo 'NC';
 }
