...
$urlrefens="https://refens.grenoble-inp.fr/gi/2018/recherche/suggestions?format=html&nomComposante=gi&texteRecherche=";
...
echo "<br>";
	echo "<h2>Détail des $nbresult lignes trouvée dans hélico pour la matière  = ".$_GET['detail']. ":</h2>";
