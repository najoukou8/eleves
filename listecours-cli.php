...
echo "<br><A href=accueil_stats.php class='abs'> Revenir à l'accueil stats </a><br>";
echo "<br><A class='abs' href=".$URL."?listegpe=1 >Liste des cours ".$anneeRefens."-".($anneeRefens+1)." importés de refens (avec les effectifs)  </a><br>";	
...
$tabletemp="cours";
$champs=champsfromtable($tabletemp);
	$query ="SELECT distinct code_etudiant ,Nom,`Code étape` as codeEtape FROM ligne_groupe
left join groupes on code_groupe= code
left join etudiants on code_etudiant= `Code etu`
