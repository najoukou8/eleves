...
$serveur="https://web.gi.grenoble-inp.fr/eleves/";
$url_personnel="https://web.gi.grenoble-inp.fr/eleves/";
$url_eleve="https://web.gi.grenoble-inp.fr/etud-auth/";
$chemin_images="../eleves/photos/";
$chemin_images_perso="../eleves/upload/photos/";
$chemin_local_images="/var/www/html/eleves/photos/";
$chemin_local_images_perso="/var/www/html/eleves/upload/photos/";
$chemin_local_ext_ia="";
$chemin_root_relatif_perso="../eleves/";
$chemin_root_relatif_eleve="../etud-auth/";
//dossier upload
$dossier = '/var/www/html/eleves/upload/';
$dossierphotos = "/var/www/html/eleves/upload/photos/";
//upload apprentissage
//upload apprentissage
$chemin_local_apprentissage = "/var/www/html/eleves/upload_local/offres_apprentissage/";
$chemin_local_eleve_acteur = "/var/www/html/eleves/upload/eleve_acteur/";
$chemin_local_absences = "/var/www/html/eleves/upload/absences/";
$chemin_local_voeux = "/var/www/html/eleves/upload/voeux/";
$chemin_local_interculture = "/var/www/html/eleves/upload/interculture/";
$chemin_local_depart = "/var/www/html/eleves/upload/eleve_depart/";
$chemin_local_portedocuments = "/var/www/html/eleves/upload/portedocuments/";
$chemin_eleve_acteur='../../eleves/upload/eleve_acteur/';
$chemin_depart='../../eleves/upload/eleve_depart/';
$chemin_absences='../../eleves/upload/absences/';
$chemin_apprentissage_local='../../eleves/upload_local/offres_apprentissage/';
$chemin_apprentissage='../eleves/upload_local/offres_apprentissage/';
$chemin_voeux='../eleves/upload/voeux/';
$chemin_interculture = "../../eleves/upload/interculture/";
$chemin_portedocuments='../../eleves/upload/portedocuments/';
$chemin_jboil_portedocuments = '/eleves/upload/portedocuments/images'; // Relative to domain name
$chemin_local_jboil_portedocuments  = '/var/www/html/eleves/upload/portedocuments/images';
// pour pchart
$cheminPchart="pchart";
$cheminUploadGraphiques="../eleves/upload/graphiques/";
$listeouinon=array('oui','non') ;
$scol_user='scol';
// le DE pour accéder à l'interface de des absences/
$de_user_liste=array('jouffral','papav','mazzontm','demichev','malandrs','cataldic','foukan','administrateur','lemairpi');
...
$directeur_user_liste=array('noelf');
// pour l'instant $nomail_user_liste peut uniquement changer le champ nomail dans groupe.php
...
$ipid_user_liste=array('administrateur','patouilm','jouffral','catussen','cataldic','anceychr','chretief','foukan','boissino','cazeauxj');
$ipid_poweruser_liste=array('administrateur','patouilm','cataldic','anceychr','foukan','boissino','jouffral');
// pour le peuplement des groupes etrangers
$ri_admin_liste=array('administrateur','dehemchn','cataldic','anceychr','phourats');
// resp annees + eleve acteur
$ri_modif_groupe=array('cambazah','brianto','catussen','dimascom','patouilm','thomanng','davidpie','foukan');// pour pouvoir modifier les membres d'un gpe mais pas modifier les caractéristiques du gpe: par import par ex, on y met les resp d'année
// pour les badges
...
//Debut voeux 5//
$courspossible5=array('Ingenierie de Produits-IDP','Ingenierie de la chaine logistique-ICL','INDIFFERENT');
...
$liste_type_ue19=array('NC','option1 icl','option2 icl','option3 icl','option4 icl',
'option1 idp','option2 idp','option3 idp','option4 idp');
...
$chemin_upload21='../eleves/upload/voeux21/';
$chemin_local_upload21 = '/var/www/html/eleves/upload/voeux21/';

//Debut voeux 22//
$courspossible22=array();
$question_commentaire22_1="-indiquez ici tout commentaire utile :";
$chemin_upload22='../eleves/upload/voeux22/';
$chemin_local_upload22 = '/var/www/html/eleves/upload/voeux22/';

//Debut voeux 23//
$courspossible23=array();
$question_commentaire23_1="-indiquez ici tout commentaire utile :";
$chemin_upload23='../eleves/upload/voeux23/';
$chemin_local_upload23 = '/var/www/html/eleves/upload/voeux23/';

// paramêtres généraux de fin //
//$ent_user='glorion';
//$ent_user='re';
$commail='Marie-Brigitte.De-Mathan@grenoble-inp.fr';
$demail='pierre.lemaire@grenoble-inp.fr';
...
// se change en juin/juillet 15/07/2024 
$annee_accueil_bascule ='2024-2025';
// pour les etudiants en accueil au moment du choix de leurs cours en juin , ils doivent voir l'edt ade de l'année n+1
$lien_ade_etr_pers="https://edt.grenoble-inp.fr/2024-2025?";
$lien_ade_etr_etu="https://edt.grenoble-inp.fr/2024-2025/etudiant/gi?";
$lien_ade_etr_ext="https://edt.grenoble-inp.fr/2024-2025/exterieur?";
$lien_synchro_ade_etr="https://edt.grenoble-inp.fr/directCal/2024-2025/exterieur?";
...
$date_debut_projetADE="16/08/24";
$lien_ade6="https://edt.grenoble-inp.fr/2024-2025?";
$lien_ade_pers="https://edt.grenoble-inp.fr/2024-2025?";
$lien_ade_etu="https://edt.grenoble-inp.fr/2024-2025/etudiant/gi?";
$lien_synchro_ade6="https://edt.grenoble-inp.fr/directCal/2024-2025/exterieur?";
...
if (ask_giusersparamcommuns('service_scol')['statut'][0]=='OK')
{
	...
	$scol_user_liste[]='foukan';
	//$scol_user_liste[]= 'reverdth' ;
	$scol_user_liste[]= 'lemairpi' ; 
