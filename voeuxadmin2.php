...
$where="where etudiants_scol.annee like '".$gpecible2."%' ";
//$nom_univ='';
// on forge le where sql
$wherecours = " 0 ";
$wherecours2 = " 0 ";
$wherecourstot = " 0 ";
foreach ($courspossible2 as $ci){
$wherecours.= " or  code='".$ci."'";
}
foreach ($cours2possible2 as $ci){
...
//$orderby="\"".$orderby.  "\"";
   ...
   //seules les personnes autorisées ont acces à la page
if(in_array($login,$voeux_liste2)){
	// $affichetout=1;
// }else
	// {$affichetout=0;
	// }
...
//on remplit 1tableau avec les libelles-code cours pour le 1er gpe
$sqlquery2="SELECT * FROM cours where ".$wherecours ." order by CODE";
$resultat2=mysql_query($sqlquery2,$connexion ); 
while ($v=mysql_fetch_array($resultat2)){
$cours_code[]=$v["CODE"] ;
$cours_libelle[]=$v["LIBELLE_LONG"] ;
$cours_libelle_a[$v["CODE"]]=$v["LIBELLE_LONG"];
}
$cours_code[]='9999';
$cours_libelle[]='NC';
...
echo affichemenuplus2tab ('Voeu 1 '.$titre1_bloc2,'v_voeux1',$cours_libelle,$cours_code,$v_voeux1);
echo affichemenuplus2tab ('Voeu 2 '.$titre1_bloc2,'v_voeux2',$cours_libelle,$cours_code,$v_voeux2);
echo affichemenuplus2tab ('Voeu 3 '.$titre1_bloc2,'v_voeux3',$cours_libelle,$cours_code,$v_voeux3);
echo "</tr><tr>";
echo affichemenuplus2tab ('Voeu 1 '.$titre2_bloc2,'voeu_parcours_1',$cours_libelle2,$cours_code2,$voeu_parcours_1);
echo affichemenuplus2tab ('Voeu 2 '.$titre2_bloc2,'voeu_parcours_2',$cours_libelle2,$cours_code2,$voeu_parcours_2);
...
echo "<table border=1 width='50%'>";
	...
	echo "</tr><tr>";
	echo "<th>Lien</th><th>Liste ".$titre1_bloc2."</th>";
	//echo "<th>Lien</th><th>Liste ".$titre1_bloc2."</th><th>heures CM</th><th>heures TP</th><th>heures TD</th>";
...
echo"   <tr><td>" ;  
	...
	echo"   <br><br>" ; 	
echo "<table border=1  width='50%'>";
		echo "<th>Lien</th><th>Liste ".$titre2_bloc2."</th>";
		//echo "<th>Lien</th><th>Liste ".$titre2_bloc2."</th><th>heures CM</th><th>heures TP</th><th>heures TD</th>";
...
echo"<th>voeu2 ".$titre1_bloc2."</th>";
//echo afficheentete('voeu3','v_voeux3',$_GET['env_orderby'],$_GET['env_inverse'],$filtre,$URL);
echo"<th>voeu3 ".$titre1_bloc2."</th>";
echo"<th>voeu1 ".$titre2_bloc2."</th>";
echo"<th>voeu2 ".$titre2_bloc2."</th>";
//echo"<th>voeu3 ".$titre2_bloc2."</th>";
...
FROM voeux_eleves
WHERE v_id_sondage='".$idsondage2."' and v_num_etudiant='".$codeetu."'
";
$result2 = mysql_query($query2,$connexion ); 
