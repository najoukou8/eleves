...
$where="where etudiants_scol.annee like '".$gpecible7."%' ";
//$nom_univ='';
...
if(in_array($login,$voeux_liste7)){
...
foreach ($courspossible7 as $coursenum ){
...
$v=mysql_fetch_object($result) ;
 ...
 //on fait une boucle pour remettre en hiden tous les champs  de la table stage
  ...
  //echo"<input type='hidden' name='mod' value=1>";
	...
	echo "<center><h1>$titrevoeux7</h1><br>";
...
FROM voeux_eleves
WHERE v_id_sondage='".$idsondage7."' and v_num_etudiant='".$codeetu."'
";
