 ...
 *==================================================*/
// modifié par MARC pour récupérer aussi la couleur de l'option du select 
  ...
  this.init = function() {
    ...
    if (this.selectobj && this.selectobj.options) {
      for (var i=0; i < this.selectobj.options.length; i++) {
		...
		// modif MARC 03-2014
		 // récupérer la backgroundColor for the Option
        this.optionscopy[i].color = selectobj.options[i].style.backgroundColor;
		// fin modif
  ...
  this.set = function(pattern) {
    ...
    for (loop=0; loop < this.optionscopy.length; loop++) {
      ...
      if ((this.match_text && regexp.test(option.text)) ||
        ...
        this.selectobj.options[index] = new Option(option.text, option.value,option.color, false);
		// modif MARC 03-2014
		  this.selectobj.options[index++].style.backgroundColor = this.optionscopy[loop].color;
		// fin modif
      }
    }
