...
//+++++++++++++++++++++++++++++++++++++++++++++++++
echo"le nom des élèves avec 3 absences ou plus dans l'année scolaire apparait en <b style='background-color : orange ; padding:4px ; color : white'>orange</b> </center>";
...
if(sizeof($liste_champs_filtre_partiel_motcles)>0){
	echo"<br>Vous pouvez filtrer le tableau sur certaines colonnes en saisissant le texte recherché dans la zone prévue (pour tout reprendre laissez vide et validez) </center><hr><br>";
	}
        echo "<table class='table1' >";
